...
def wandb_set():
    ...
    flags.DEFINE_string(
        "wandb_run_name", "MNC_resnet18(14*14*512)_mask_original_loss_Beta_0_1_alpha_schedule",
...
def Configure_Saving_and_Restore_Model():
    ...
    flags = Mock_Flag()
    flags.DEFINE_string(
        'model_dir', "/data1/resnet_byol/MNC_resnet18(14_14_512)_mask_original_loss_Beta_0_1_alpha_schedule",
