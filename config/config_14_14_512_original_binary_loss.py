...
def wandb_set():
    ...
    flags.DEFINE_string(
        "wandb_run_name", "MNC_resnet18(14*14*512)_mask_original_loss_Beta_0_6_alpha_1",
...
def Configure_Saving_and_Restore_Model():
    ...
    flags.DEFINE_string(
        ...
        'model_dir', "/shared_SSD_20TB/SSL_TEAM/check_point/resnet_byol/MNC_resnet18(14_14_512)_mask_original_loss_Beta_0_6_alpha_1",
