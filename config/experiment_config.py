...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "MNC_(7_7_2048)_100epoch_alpha_schedule_symlpss"
    FLAGS.wandb_mod = "run"
    ...
    FLAGS.model_dir = "/data1/share/resnet_byol/reatnet50/MNC_(7_7_2048)_100epoch_alpha_schedule_symlpss"
