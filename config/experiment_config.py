...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "MNC_(14_14_2048)_100epoch_alpha_schedule_symloss"
    FLAGS.wandb_mod = "run"
    ...
    FLAGS.non_contrast_binary_loss = "sum_symetrize_l2_loss_object_backg"#sum_symetrize_l2_loss_object_backg_add_original
    FLAGS.alpha = 1
    ...
    FLAGS.model_dir = "/data1/share/resnet_byol/resnet50/MNC_(14_14_2048)_100epoch_alpha_schedule_symloss"
