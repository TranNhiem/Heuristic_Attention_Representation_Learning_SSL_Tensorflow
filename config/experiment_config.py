...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "Hybrid_loss_(7*7*2048)_100epoch_alpha_schedule_symloss"
    FLAGS.wandb_mod = "run"
    ...
    FLAGS.model_dir = "/data1/share/resnet_byol/resnet50/Hybrid_loss_(7*7*2048)_100epoch_alpha_schedule_symloss"
