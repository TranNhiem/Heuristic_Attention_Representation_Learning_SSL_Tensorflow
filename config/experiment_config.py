...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.non_contrast_binary_loss = "Baseline loss"#sum_symetrize_l2_loss_object_backg_add_original sum_symetrize_l2_loss_object_backg_add_original
    FLAGS.alpha = 1
    ...
    FLAGS.model_dir = "/data1/share/resnet_byol/resnet50/Baseline_(7_7_2048)_100epoch_symloss"
