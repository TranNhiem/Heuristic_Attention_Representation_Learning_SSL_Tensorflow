...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.num_workers = 2
    FLAGS.communication_method = "NCCL"  # auto
    ...
    FLAGS.single_machine_train_batch_size = 1024
    FLAGS.single_machine_val_batch_size = 1024
    FLAGS.model_dir = "/data1/resnet_byol/resnet18_correction/test_multi_machine"
