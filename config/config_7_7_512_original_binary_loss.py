...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "MNC_resnet50_14_14_Binary_loss_7_7_original_loss_alpha_1_beta_0_5"
    ...
    FLAGS.model_dir = "/data1/resnet_byol/MNC_resnet50_14_14_Binary_loss_7_7_original_loss_alpha_1_beta_0_5"
