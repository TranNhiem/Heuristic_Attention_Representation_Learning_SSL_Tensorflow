...
def read_cfg(mod="non_contrastive"):
    ...
    FLAGS.wandb_run_name = "MNC_resnet18_56_56_Binary_loss_7_7_original_loss_alpha_schedule_beta_0_5"
    ...
    FLAGS.model_dir = "/data1/share/resnet_byol/MNC_resnet18_56_56_Binary_loss_7_7_original_loss_alpha_schedule_beta_0_5"
