...
def wandb_set():
    ...
    flags.DEFINE_string(
        "wandb_run_name", "MNC_resnet18(28*28*128)_mask_original_loss_Beta_0_5_alpha_1",
...
def Configure_Saving_and_Restore_Model():
    ...
    flags = Mock_Flag()
    flags.DEFINE_string(
        'model_dir', "/data1/share/check_point/resnet_byol/MNC_resnet18(28_28_128)_mask_original_loss_Beta_0_5_alpha_1",
