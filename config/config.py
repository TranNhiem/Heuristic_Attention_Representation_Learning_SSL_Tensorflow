...
class Flage():
    def __init__(self):
        ...
        self.flags.DEFINE_float('weight_decay', 1e-6, 'Amount of weight decay to use.')
        ...
        self.flags.DEFINE_boolean('lineareval_while_pretraining', True,
