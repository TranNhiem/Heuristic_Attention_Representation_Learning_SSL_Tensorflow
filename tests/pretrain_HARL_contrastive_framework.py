...
from HARL.loss.self_supervised_losses import binary_mask_nt_xent_object_backgroud_sum_loss
...
def main(argv):
    ...
    configs = {
        ...
        "DataAugmentation_types": "simclr_random_global_crop_image_mask",
        "Dataset": "ImageNet1k",
        ...
        "Loss Version": FLAGS.loss_options,
    }
